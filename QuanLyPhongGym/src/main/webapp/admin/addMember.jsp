...
<body>
	...
	<h3 class="text-center text-danger">Thêm hội viên</h3>
	<br>
	<div class="container">
			...
			<div class="card">
				<div class="card-body">
					...
					<form action="../AddMemberServlet" method="post"
						onsubmit="return MobileValidate() accept-charset="UTF-8" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="number" name="initamount" class="form-control"
									id="inputAddress" placeholder="Enter Initial Amount(In VND)"
									style="width: 600px;" required>
							</div>
						</div>
